...
// see https://github.com/Modernizr/Modernizr/blob/master/feature-detects/storage/localstorage.js
    ...
    function init(self, source, options) {
        ...
        self.emojiTemplate = '<img style="width: 20px; height: 20px" alt="{alt}" class="emojione' + (self.sprite ? '-{uni}" src="' + blankImg + '"/>' : 'emoji" src="{img}"/>');
    ...
    $.fn.emojioneAreaText = function(options) {
        ...
        var self = this, pseudoSelf = {
            ...
            emojiTemplate: '<img style="width: 20px; height: 20px" alt="{alt}" class="emojione' + (options && options.sprite && emojioneSupportMode < 3 ? '-{uni}" src="' + blankImg : 'emoji" src="{img}') + '"/>'
        };
