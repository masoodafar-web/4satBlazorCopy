...
imported.src = '/Content/js/DateConverter.js';
...
(function ($, window, document, undefined) {
    ...
    var pluginName = 'dropdownDatepicker',
        pluginDefaults = {
            ...
            wrapperClass: 'dropDownDateWrapper',
            selectElementClass: "form-control col-12",
            dropdownClass: "col-4 dropDownDateSelect",
            daySuffixes: false,
            monthSuffixes: true,
            monthFormat: 'long',
            required: false,
            ...
            yearLabel: 'سال',
            sortYear: 'desc',
            monthLongValues: ['فروردین', 'اردیبهشت', 'خرداد', 'تیر', 'مرداد', 'شهریور', 'مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند'],
            monthShortValues: ['یک', 'دو', 'سه', 'چهار', 'پنج', 'شش', 'هفت', 'هشت', 'نه', 'ده', 'یازده', 'دوازده'],
    ...
    $.extend(Plugin.prototype, {
        ...
        setInternalVariables: function () {
            ...
            var d = date.getDate();
            var jalali = ginj(y, m, d);
            this.internals.currentDay = jalali.d;
            this.internals.currentMonth = jalali.m;
            this.internals.currentYear = jalali.y;
        },
        ...
        setupMarkup: function () {
            ...
            if (this.element.tagName.toLowerCase() === 'input') {
                ...
                this.$element.addClass(this.config.selectElementClass);
        ...
        bindChangeEvent: function () {
            ...
            objectRefs.pluginWrapper.on('change', 'select', function () {
                ...
                objectRefs.hiddenField.change().blur().focus();
        ...
        buildDayOptions: function (month, year) {
            ...
            var numDaysInMonth = daysInMonth(year, month, "persian");
        ...
        buildYearOptions: function () {
            ...
            if (!minYear) {
                minYear = this.config.allowPast ? 1300 : this.internals.currentYear;
            } else {
