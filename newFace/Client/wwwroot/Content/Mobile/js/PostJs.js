...
var uploadCrop = $('#image_here').croppie({
    enableExif: true,
    viewport: {
        width: 290,
        height: 260
        ...
        var type  = 0;
           $.ajax({
               ...
               success: function (data) {
                   ...
                   if (stat == 1)
                   {
                       $('#'+id).html('<i class="text-danger fa fa-heart"></i> به علاقه مندی ها اضافه شد');

                       }
                   else{
                       $('#'+id).html('<i class="fa fa-heart"></i> اضافه به علاقه مندی ها');
                    ...
                    if (statusIntro == false) {
                        ...
                        var intro = new Anno([
                            ...
                            },
                            {
                                ...
                                content: "با ورود به این قسمت این امکان فراهم می شود که اهدافی را انتخاب کنید تا از سیستم مشاوره بهره بیشتری ببرید.",
                                position: 'left'
                            },
                            {
                                target: '#store-intro',
