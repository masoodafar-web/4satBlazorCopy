...
$("#close-sidebar").click(function () {
    $(".page-wrapper").removeClass("toggled");
    $('#sidebar #chat #text-chat').animate({right: '-300'}, 150);
...
$('.expand-button').on('click', function(){
    ...
    if ($('.special-text').hasClass('-expanded')) {
        $('.expand-button').html('بستن متن');
    } else {
        $('.expand-button').html('نمایش متن ...');
    }
});
...
//$('body .sidebar-wrapper .sidebar-content #chat #show-chat .media .media-body .left-angle-chat').addClass('d-none');
//$('body .sidebar-wrapper .sidebar-content #chat #show-chat .media .media-body .right-angle-chat').removeClass('d-none');


//$('body .sidebar-wrapper .sidebar-content #chat #show-chat .media-me .media .media-body .right-angle-chat').addClass('d-none');
//$('body .sidebar-wrapper .sidebar-content #chat #show-chat .media-me .media .media-body .left-angle-chat').removeClass('d-none');
